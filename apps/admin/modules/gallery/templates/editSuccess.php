...
<div class="whtcrv-mn">
    ...
    <div class="whtcntn-mn">
    	<div class="pagehead">
    		<?php echo label_for('',__('Edit User',null,'edit')); ?>
			...
			<div class="userlist-mn">
				<div class="signupform-row">
            		<?php echo label_for('',"<font color='red'>*</font>".__('Item Title :',null,'user')); ?>
                ...
                <div class="signupform-row">
					...
					{
						echo label_for('',image_tag(sfConfig::get('app_webpath').'/uploads/gallery/'.$data->getId().'/thumbnail/'.$data->getImage()),'class="users" style="width:221px;"');
					}
					?>
