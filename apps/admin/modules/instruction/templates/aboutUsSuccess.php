...
<div class="whtcrv-mn">
    ...
    <?php echo form_tag('instruction/aboutUs'); ?>
    <div class="whtcntn-mn">
    	...
    	<div class="pagehead"><?php echo label_for('',__('About Us',null,'instructions')); ?></div>
    	<div style="float:left">
	        <?php
	        echo textarea_tag('aboutus',$contents,array('id'=>'aboutusid'));
			echo include_partial('global/tinymce',array('textfield_id' => 'aboutusid' ));
			
	        	
	        	/*echo textarea_tag('aboutus',$contents);
	        	echo textarea_tag('aboutus',$contents ,array('rich'=>true
					,'size'=>'900x900'
					,'tinymce_options'=>'
        ...
        <div class="savemn">
        	<span class="inptsv-lft">
            	<?php echo submit_tag(__('Save',null,'aboutUs')); ?>
            </span>
        </div>
    </div>
    </form>
