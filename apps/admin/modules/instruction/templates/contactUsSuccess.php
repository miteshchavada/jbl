...
<div class="whtcrv-mn">
    ...
    <?php echo form_tag('instruction/contactUs'); ?>
    <div class="whtcntn-mn">
    	...
    	<div class="pagehead">
    		<?php echo label_for('',__('Contact Us',null,'instructions')); ?>
    	</div>
    	<div style="float:left">
			<?php
				echo textarea_tag('contactus_data',$contents,array('id'=>'contactusid'));
				echo include_partial('global/tinymce',array('textfield_id' => 'contactusid' )); 
				//echo textarea_tag('contactus_data',$contents,'size=80x20');
				/*echo textarea_tag('contactus_data',$contents ,array('rich'=>true
							,'size'=>'900x900'
							,'tinymce_options'=>'
        ...
        <div class="savemn">
        	<span class="inptsv-lft">
            	<?php echo submit_tag(__('save',null,'contactUs')); ?>
            </span>
        </div>
    </div>
    </form>
