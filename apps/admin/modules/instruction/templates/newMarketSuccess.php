...
<div class="whtcrv-mn">
    ...
    <?php echo form_tag('instruction/newMarket'); ?>
 	<div class="whtcntn-mn">
    	<div class="txtsubmit">
			...
			<div class="pagehead">
				<?php echo label_for('',__('New Market',null,'instructions')); ?>
			</div>
			<div style="float:left">
				<?php 
					
					echo textarea_tag('new_market',$contents,array('id'=>'new_marketid'));
					echo include_partial('global/tinymce',array('textfield_id' => 'new_marketid' ));
					
					//echo textarea_tag('new_market',$contents,'size=80x20');
					/*echo textarea_tag('new_market',$contents ,array('rich'=>true
							,'size'=>'900x900'
							,'tinymce_options'=>'
