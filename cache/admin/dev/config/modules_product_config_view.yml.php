...
if ($this->actionName.$this->viewName == 'changeLocationSuccess')
{
...
if ($templateName.$this->viewName == 'changeLocationSuccess')
{
  ...
  $response->addStylesheet('fisheye-menu', '', array ());
  $response->addStylesheet('dock', '', array ());
  $response->addStylesheet('skin', '', array ());
